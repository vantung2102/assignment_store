...
# RSpec.describe Admin::Products::UpdateService, type: :service do

#   subject { described_class.new(product, product_params) }

#   let!(:brand) { FactoryBot.create(:brand) }

#   let!(:product) { FactoryBot.create(:product, price: nil, brand_id: brand.id) }
#   let!(:product_attribute) { FactoryBot.create(:product_attribute, product_id: product.id) }
#   let!(:attribute_value) { FactoryBot.create(:attribute_value, product_id: product.id) }
#   let!(:product_attribute) { FactoryBot.create(:product_attribute, product_id: product.id) }
